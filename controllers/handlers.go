...
import (
	...
	"smartmobilelabs.com/evo/evo-operator/controllers/helm"
	"smartmobilelabs.com/evo/evo-operator/controllers/k8sdynamic"
	"smartmobilelabs.com/evo/evo-operator/controllers/kubelib"
	"smartmobilelabs.com/evo/evo-operator/controllers/licenceexpired"
	"smartmobilelabs.com/evo/evo-operator/controllers/monitoring"
	"smartmobilelabs.com/evo/evo-operator/controllers/platformres"
	"smartmobilelabs.com/evo/evo-operator/controllers/template"
)
...
func (r *SmlEvoReconciler) handleCrChange(instance *app.SmlEvo, namespace string) (reconcile.Result, error) {
...
func isSpecUpdated(instance *app.SmlEvo) bool {
	return instance.Status.PrevSpec != nil && !reflect.DeepEqual(instance.Spec, *instance.Status.PrevSpec)
}

func (r *SmlEvoReconciler) handleDelete(instance *app.SmlEvo, namespace string) (reconcile.Result, error) {
...
func (r *SmlEvoReconciler) handleUpdate(instance *app.SmlEvo, namespace string) (reconcile.Result, error) {
...
func (r *SmlEvoReconciler) handleCreate(instance *app.SmlEvo, namespace string) (reconcile.Result, error) {
	...
	for _, deployment := range deploymentList {
		...
		for _, netAnn := range parsedNetAnn {
			if netAnn.Name == pnaNetworkName {
				//CKETODO retIpAddresses[string(deployment.deploymentType)+"/"+deployment.name] = netAnn.IPRequest
			}
		}
	}
